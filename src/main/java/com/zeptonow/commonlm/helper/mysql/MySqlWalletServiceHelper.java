...
public class MySqlWalletServiceHelper {

  private ThreadLocal<Connection> connection =
      ThreadLocal.withInitial(
          () -> {
            return new ConnectionHelper().getPostgresDbInstance(Services.ZEPTOWALLET);
          });
  ...
  /**
   * This wrapper function is used to query zepto-wallet database
   *
   * @param query
   * @return
   * @throws SQLException
